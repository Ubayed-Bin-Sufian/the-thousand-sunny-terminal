...
import { CrewMember, DialogueLine } from '../../types';
...
export class CrewPortrait extends Phaser.GameObjects.Container {
  ...
  private bubbleName!: Phaser.GameObjects.Text;

  constructor(scene: Phaser.Scene, x: number, y: number, crew: CrewMember) {
    super(scene, x, y);
  ...
  private setupSprite(crew: CrewMember): void {
  ...
  private setupSpeechBubble(): void {
  ...
  public showDialogue(line: DialogueLine): void {
      // Set values
