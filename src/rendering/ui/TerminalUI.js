...
export class TerminalUI extends Phaser.GameObjects.Container {
    ...
    createScanlines() {
        ...
        graphics.destroy();
        const overlay = this.scene.add.tileSprite(this.scene.cameras.main.centerX, this.scene.cameras.main.centerY, this.scene.cameras.main.width, this.scene.cameras.main.height, 'scanline');
